		...
		<tbody>
			...
			<tr>
				<td colspan="2">
					...
					<a href="boardEdit.html?boNum=${board.boNum }" class="btn btn-success btn-sm">
	...
	$(document).ready(function() {
		...
		$("#btn_reply_modify").click(function(e) {
			...
			$.ajax({
				...
				error : function(req, st, err) {
					console.log("req", req); //////////////여기
					if (req.status == '401') {
						location.href = "<%=request.getContextPath()%>/login/login.wow"
					} else {
          			}					
				}
			}); // ajax
