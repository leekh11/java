	...
	<div class="container">
					...
					<div class="form-group">
						...
						<div class="col-sm-2">
							<select id="id_searchType" name="searchType"
								...
								<option value="SB"
									${searchVO.searchType eq 'HP' ? 'selected' : ''}>성별</option>
							</select>
						</div>
						<div class="col-sm-2">
		...
		<div class="row">
			...
			<div class="col-sm-2 col-sm-offset-7 text-right"
				...
				<a href="memberListM.wow" class="btn btn-warning btn-sm"> <span
					class="glyphicon glyphicon-plus-sign" aria-hidden="true"></span>&nbsp;삭제하기
				</a>
			</div>
		</div>
